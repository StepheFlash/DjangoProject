...
# Render external hostname (backward compatibility)
...
if os.environ.get('ALLOWED_HOSTS_EXTRA'):
    ALLOWED_HOSTS.extend(os.environ.get('ALLOWED_HOSTS_EXTRA').split(','))
...
DATABASES = {
   'default': dj_database_url.config(
        default=os.environ.config(default=os.getenv('DATABASE_URL'))
    )
}
# else:
...
if not DEBUG:
    ...
    # Development: disable redirect and secure cookies
