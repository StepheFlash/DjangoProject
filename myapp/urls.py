...
urlpatterns = [
    ...
    path('content/development/', views.content_development, name='content_development'),
    ...
    path('projects/<int:id_document>/delete/document/', views.project_document_delete, name='project_document_delete'),
    ...
    path('activity_resources/<int:id_resource>/delete',views.activity_resources_delete,name="activity_resources_delete"),
